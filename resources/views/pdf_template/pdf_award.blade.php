...
<head>
    ...
    <style>
     body{
        background-image:url('images\\award_template.png');
...
<body>
    <div style="position: relative; width: 1123px; height: 794px;">
            <div style="position: absolute; top: 300px; left: 0; width: 70%; text-align: center;">
            ...
            <div style="position: absolute; top: 500px; left: 0; width: 70%; text-align: center;">
                <h1>{{ strtoupper($projects->award) }}</h1>
            </div>

            <div style="position: absolute; top: 650px; left: 0; width: 70%; text-align: center;">
